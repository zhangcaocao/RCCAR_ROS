...
void moveBase()
{
    ...
    char buffer[50];
    sprintf (buffer, "pwm  : %ld", (long int)(motor1_pid.compute(req_rpm.motor1, current_rpm1)));
    nh.loginfo(buffer);
    ...
    /*
    emmm  这个地方，，不应该除以2的，但是我实际跑出来就是应该处以2， （单电机 舵机转向！）。
    */
//    raw_vel_msg.linear_x = current_vel.linear_x
    raw_vel_msg.linear_x = (current_vel.linear_x/2)*0.9;
...
void printDebug()
{
    ...
    sprintf (buffer, "Encoder  : %ld", motor1_encoder.read());
    nh.loginfo(buffer);
