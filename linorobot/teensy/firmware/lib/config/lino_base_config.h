...
#define COUNTS_PER_REV 330       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.1       // wheel's diameter in meters
#define PWM_BITS 0.8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.20  // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.20   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
#define MAX_STEERING_ANGLE 0.20  // max steering angle. This only applies to Ackermann steering
